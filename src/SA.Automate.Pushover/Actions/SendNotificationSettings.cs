...
public class SendNotificationSettings
{
    ...
    [Field(Label = "Title", Description = "An optional title to display above the message. Supports data bindings.", SupportsBindings = true)]
    public string? Title { get; set; }

    /// <summary>The main body text of the notification. Required.</summary>
    [Field(Label = "Message", Description = "The main content of the notification to be sent. Supports data bindings.", SortOrder = 1, SupportsBindings = true )]
    ...
    /// </summary>
    [Field(Label = "Sound", Description = "The sound to play on the device when the notification arrives. See https://pushover.net/api#sounds", SortOrder = 2)]
    ...
    /// </summary>
    [Field(Label = "URL",  Description = "An optional URL to be included with the notification that users can open directly from Pushover. Supports standard URLs (https://) as well as mailto:, tel:, and other URI schemes. Supports data bindings using ${ binding } syntax.", SortOrder = 3, SupportsBindings = true)]
    public string? Url { get; set; }

    /// <summary>An optional display title for the URL link. When omitted, the raw URL is shown.</summary>
    [Field(Label = "URL Title", Description = "An optional title for the URL link. If not provided, the URL will be displayed as-is. Supports data bindings.", SortOrder = 4, SupportsBindings = true)]
